...
public class ConditionalVisitorOrThrow<T> implements StandardTypeVisitor<T> {

    private final StandardTypeVisitor<Boolean> predicate;

    private final StandardTypeVisitor<T> delegate;

    public ConditionalVisitorOrThrow(StandardTypeVisitor<Boolean> predicate, StandardTypeVisitor<T> delegate) {
