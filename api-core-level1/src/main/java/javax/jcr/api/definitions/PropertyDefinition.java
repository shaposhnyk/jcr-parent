...
public interface PropertyDefinition extends ItemDefinition {
     ...
     */
    Collection<String> getValueConstraints();
     ...
     * <code>true</code>).
     * <p>
     * This method returns an array of <code>ImmutableValue</code> objects. If the
     ...
     * <code>null</code>.
     *
     * @return an array of <code>ImmutableValue</code> objects.
     */
    default Collection<ImmutableValue> getDefaultValues() {
     ...
     * @since JCR 2.0
     */
    Collection<String> getAvailableQueryOperators();
     ...
     * @since JCR 2.0
     */
    default boolean isQueryOrderable() {
        return false;
    }
}
