 ...
 */
public class DynamicAdapterUserRepoTest extends UserRepositorySupport {
    ...
    public Repository createWs() {
        try {
            ...
            Repository repo = AvroAdapter.createWs(new File("/tmp/test.avro"));
            return DynamicAdapter.createWs(repo);
        } catch (IOException e) {
    ...
    public void testReference() {
        ...
        ImmutableNode fb = ws.getRootNode().getItem("primaryIdentity");
        assertThat(fb, notNullValue());
        assertThat(fb.getItem("secretId").getValue(), equalTo("some@one.com"));
    }
